...
* Listar produtos pai (erp/produtos.json)</br>
* Listar variações de produtos pai (erp/variacoes.json)</br></br>
...
* Descrição de como utilizou a IA a seu favor;</br></br>
Diferencial</br>
* Laravel 8+;</br>
* Teste Unitário;</br>
